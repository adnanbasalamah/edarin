...
- **Sales & Returns Input:** Distributors can input sales quantities per product per store, along with return quantities.
- **Reports & Analytics:** Distributors can view and download their own sales data (daily/weekly/monthly). Admins can view all distributor data across the network.
